    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formUsername">
                <Form.Control value={username} onChange={handlerUsernameChange} type="username" placeholder="Enter username" />
            </Form.Group>
            ...
            <Form.Group controlId="formPasswordRepeat">
                <Form.Control value={passwordRepeat} onChange={handlePasswordRepeatChange} type="password" placeholder="Repeat Password" />
            </Form.Group>
